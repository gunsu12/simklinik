                        ...
                        <div role="tabpanel" class="tab-pane in active" id="home" > 
                        	<!-- <form action="" method="POST"> -->
	                        	<div class="row clearfix">
								    ...
								    <div class="col-sm-2">
								            <button type="button" class="btn btn-raised g-bg-cyan btn-block btn-lg waves-effect" data-toggle="modal" data-target="#">Jadwal Dokter</button>
								    </div>
								    <div class="col-sm-4">
								    ...
								    <div class="col-sm-4">
								        <div class="form-group">
								            <div class="form-line">
								                <input type="text" name="antrian_no" class="form-control" placeholder="No Antrian" id="antrian_no">
								            </div>
								        </div>
								    </div>
								</div>
								<div class="row clearfix">
								    ...
								    <div class="col-sm-4">
								        <div class="form-group">
								            <div class="form-line">
								                <input type="text" name="tanggal_register" class="datepicker form-control" placeholder="Tanggal Lahir" id="tanggallahir" id="tanggal_lahir">
								            </div>
								        </div>
								    </div>
								</div>
								<div class="row clearfix">
								    ...
								    <div class="col-sm-3">
								        <div class="form-group">
								            <div class="form-line">
								                <input type="text" name="oleh" class="form-control" placeholder="Oleh" id="oleh">
								            </div>
								        </div>
								    </div>
								    <div class="col-sm-3">
								        <div class="form-group drop-custum">
								            <select class="form-control show-tick" id="tipe">
								                <option value="">-- Tipe Booking --</option>
								    ...
								    <div class="col-sm-3">
								        <div class="form-group">
								            <div class="form-line">
								                <input type="text" name="tanggal_booking" class="datepicker form-control" placeholder="Tanggal Booking" id="tanggalbooking" id="tanggal_booking">
								            </div>
								        </div>
								    </div>
								</div>
