			...
			<div class="col-lg-12 col-md-12 col-sm-12">
				<div class="card">
                    ...
                    <ul class="nav nav-tabs">
                        ...
                        <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#profile">List Jaminan</a></li>
                        	...
                        	<div class="row clearfix">
                        		<div class="col-sm-2">
							        <div class="form-group">
							            <div class="form-line">
							                <input type="text" class="form-control" placeholder="Kode Jaminan">
							            </div>
							        </div>
							    </div>
							    <div class="col-sm-6">
							        <div class="form-group">
							            <div class="form-line">
							                <input type="text" class="form-control" placeholder="Nama Jaminan">
							            </div>
							        </div>
							    </div>
							    <div class="col-sm-2">
							        <div class="form-group">
							            <div class="form-line">
							                <input type="text" class="form-control" placeholder="Up Tarif">
							            </div>
							        </div>
							    </div>
							    <div class="col-sm-2">
